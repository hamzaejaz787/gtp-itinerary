      ...
      <div className="flex-col lg:w-[70%] md:w-[90%] w-[90%]">
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-10">
          <div className="grid grid-cols gap-2">
            <h1 className="font-sans font-[700] text-[20px] leading-[33px] text-white pb-4">
              Guide To Pakistan
            </h1>
            <IconBox
          ...
          <div className="grid grid-cols gap-2">
            ...
            <IconBox text="Home" link="https://guidetopakistan.pk/" />
            <IconBox text="About Us" link="https://guidetopakistan.pk/about/" />
            <IconBox
              text="Destinations"
        ...
        <div className="flex lg:flex-row md:flex-row flex-col justify-between border border-t-2 border-b-0 border-r-0 border-l-0 border-white pt-4 mt-8">
          <p className="font-sans font-[400] text-[14px] leading-[21px] text-white pb-4">
            @Copyright 2025 Guide To Pakistan | Powered by CyberX Studio
          </p>
